    ...
    <div className="min-h-screen bg-slate-50 dark:bg-slate-950">
      ...
      <main className="max-w-7xl mx-auto px-6 py-16 space-y-20">
        ...
        <section className="space-y-10">
          <div className="flex flex-col md:flex-row md:items-end justify-between gap-4 border-b border-slate-200 dark:border-slate-800 pb-6">
            <div>
              <h2 className="text-3xl font-black text-slate-900 dark:text-white mb-2">Essential <span className="text-slate-400">SEO</span></h2>
              <p className="text-sm text-slate-500 font-medium">Standard utilities for daily optimization and tags generation.</p>
            </div>
            <div className="text-[10px] font-black text-slate-400 bg-slate-100 dark:bg-slate-800 px-3 py-1.5 rounded-full uppercase tracking-widest">
              Core SEO
            </div>
          </div>
  ...
  return (
    ...
    >
      ...
      <div className={`mt-8 pt-6 border-t font-bold text-sm flex items-center justify-between ${
        highlighted ? "border-blue-100 dark:border-blue-900/50 text-blue-600" : "border-slate-100 dark:border-slate-800 text-slate-400 group-hover:text-blue-600"
      }`}>
        <span>Open Tool</span>
